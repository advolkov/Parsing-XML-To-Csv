...
def parse_xml(xml_file):
    ...
    for item in root.findall('./PLANT'):    # find all PLANT node
...
def save_to_csv(data, csv_file):
    headers = ['COMMON','BOTANICAL','ZONE','LIGHT','PRICE','AVAILABILITY']  # headers for csv
...
xml_file = "plant.xml"  # file where the xml is saved
csv_file = "plant.csv"  # file where data is saved in csv format
